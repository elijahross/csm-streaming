  ...
  ws.onmessage = async (event) => {
    ...
    if (data.type === "saved_config" && data.config) {
      ...
      document.getElementById("referenceAudio").value =
        data.config.reference_audio_path || "";
      document.getElementById("referenceText").value =
        data.config.reference_text || "";
      document.getElementById("referenceAudio2").value =
        data.config.reference_audio_path2 || "";
      document.getElementById("referenceText2").value =
        data.config.reference_text2 || "";
      document.getElementById("referenceAudio3").value =
        data.config.reference_audio_path3 || "";
      document.getElementById("referenceText3").value =
        data.config.reference_text3 || "";

      setTimeout(() => {
        if (data.config.mic_id)
          document.getElementById("micSelect").value = data.config.mic_id;
        if (data.config.output_id)
          document.getElementById("outputSelect").value = data.config.output_id;
      }, 500);
    }
